...
const Footer = () => {
  return (
    <div>
      ...
      <div className='text-center d-flex flex-lg-row flex-wrap  justify-content-center align-items-center mx-sm-auto my-5'>
        <Link to="https://github.com/SanketWakde71405">
          <button type="button" className="btn d-block customColor rounded mx-3 svgButton">
